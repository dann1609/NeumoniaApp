...
public class RecomendacionesDiariasActivity extends AppCompatActivity {

    Context context;
    Patient p1;
    TextView puntaje,lugar,germen,tratamiento,recFinales,idpaciente;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recomendaciones_diarias);
        ...
        idpaciente.setText(p1.getIdPaciente());

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent intent = new Intent(context, ModificarDatosActivity.class);
